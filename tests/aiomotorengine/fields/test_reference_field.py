...
from motorengine.aiomotorengine import Document, StringField, ReferenceField
...
class TestReferenceField(AsyncTestCase):
    ...
    def test_create_reference_field_with_string_class(self):
        field = ReferenceField(
            db_field="test",
            reference_document_type="tests.aiomotorengine.fields.test_reference_field.User"
        )
        expect(field.reference_type).to_equal(User)
